...
public class SearchProductByKeywordUsecaseTests
{
    ...
    public async Task ExecuteAsync_ShouldReturnProducts_WhenKeywordExists()
    {
        ...
        // 商品カテゴリIdを検証する
        Assert.AreEqual(
        "a1f70bb5-aac0-4f3e-95a9-712dc100a26d", results[0].Category!.CategoryUuid);
        // 商品カテゴリ名を検証する
        ...
        // 商品カテゴリIdを検証する
        Assert.AreEqual(
        "a1f70bb5-aac0-4f3e-95a9-712dc100a26d", results[1].Category!.CategoryUuid);
        // 商品カテゴリ名を検証する
        ...
        // 商品カテゴリIdを検証する
        Assert.AreEqual(
        "a1f70bb5-aac0-4f3e-95a9-712dc100a26d", results[2].Category!.CategoryUuid);
        // 商品カテゴリ名を検証する
        ...
        // 商品カテゴリIdを検証する
        Assert.AreEqual(
        "a1f70bb5-aac0-4f3e-95a9-712dc100a26d", results[3].Category!.CategoryUuid);
        // 商品カテゴリ名を検証する
